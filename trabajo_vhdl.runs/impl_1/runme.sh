...
HD_PWD='C:/Users/maria/Desktop/ENTREGA TRABAJO SED/trabajo_vhdl_DEFINITIVO/trabajo_vhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAQUINA_CAFE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAQUINA_CAFE.tcl -notrace
